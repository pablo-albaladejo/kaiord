...
export default tseslint.config(
  ...
  ...tseslint.configs.recommended,
  {
    ignores: [
      ...
      "**/generated/**",
      // Generated design-system barrel — the bundle entry for the
      // claude.ai/design sync, regenerated by `.design-sync/gen-entry.mjs`;
      // not hand-edited, and its ~200 re-exports cannot meet max-lines.
      "packages/workout-spa-editor/design-system.ts",
    ],
  },
  {
