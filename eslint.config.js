...
export default tseslint.config(
  ...
  {
    // Generated design-system barrel — the bundle entry for the claude.ai/design
    // sync, regenerated by `.design-sync/gen-entry.mjs`. It is NOT ignored: a
    // generator can still emit a broken import or bad syntax, and that is exactly
    // what lint should catch here. Only the two rules a generated re-export list
    // cannot satisfy are switched off — its ~200 exports are grouped by component
    // layer (atoms, molecules, …) rather than sorted, which is deliberate and
    // documented in the generator.
    files: ["packages/workout-spa-editor/design-system.ts"],
    rules: {
      "max-lines": "off",
