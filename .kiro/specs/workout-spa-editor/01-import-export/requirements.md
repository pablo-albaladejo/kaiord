# Requirements Document - Import/Export FIT, TCX, and ZWO Formats

## Introduction

This feature enables the Workout SPA Editor to import and export workout files in industry-standard formats (FIT, TCX, ZWO) in addition to the native KRD format. This is critical for device compatibility and interoperability with training platforms like Garmin Connect and Zwift.
...
- **ZWO**: Zwift Workout XML - Zwift's XML format for workout data
...
3. WHEN THE TCX/ZWO XML is invalid, THE Workout SPA Editor SHALL display an error message with the XML validation error
