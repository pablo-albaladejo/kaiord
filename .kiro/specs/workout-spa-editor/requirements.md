...
**User Story:** As an athlete, I want to export my workout to FIT and TCX formats, so that I can load it directly into my training device

#### Acceptance Criteria

1. WHEN THE user initiates export, THE Workout SPA Editor SHALL provide format selection options (FIT, TCX, PWX)
2. WHEN THE user selects FIT format, THE Workout SPA Editor SHALL convert the KRD workout to FIT binary format using the @kaiord/core library
3. WHEN THE user selects TCX format, THE Workout SPA Editor SHALL convert the KRD workout to TCX XML format using the @kaiord/core library
4. WHEN THE user selects PWX format, THE Workout SPA Editor SHALL convert the KRD workout to PWX XML format using the @kaiord/core library
5. WHEN THE export conversion succeeds, THE Workout SPA Editor SHALL trigger a file download with the appropriate file extension
