...
- [ ] 2.1 Write unit tests for tag parsing
...
- [ ] 3. Create package validation utility script
...
- [ ] 3.1 Write unit tests for package validation
...
- [ ] 4. Update release workflow with tag parsing
...
- [ ] 5. Update release workflow with package validation
...
- [ ] 6. Update release workflow with selective publishing
...
- [ ] 7. Update release workflow failure notifications
...
- [ ] 8. Update release workflow summary
...
- [ ] 9. Update changesets workflow for package-scoped releases
...
- [ ] 10. Implement changelog extraction logic
...
- [ ] 10.1 Write unit tests for changelog extraction
...
- [ ] 11. Add npm package URL to release notes
...
- [ ] 12. Implement multi-package release support
...
- [ ] 13. Update README.md with release tag documentation
...
- [ ] 14. Update CONTRIBUTING.md with release process
...
- [ ] 15. Update DEPLOYMENT.md with new workflow details
...
- [ ] 16. Create release CLI helper script (optional)
...
- [ ] 16.1 Write unit tests for release CLI script
...
- [ ] 17. Checkpoint - Test with dry-run release
...
- [ ] 18. Write integration tests for release workflow
...
- [ ] 19. Write integration tests for changesets workflow
...
- [ ] 20. Write end-to-end tests for full release cycle
...
- [ ] 21. Final Checkpoint - Production release test
