...
Defines `@kaiord/ai/prompts` — the versioned prompt registry, template variable substitution, and the untrusted-data fence utility, owning the migrated workout-parser, chat, and user prompts.
