...
Defines the daily/weekly/monthly energy-balance roll-up (net = intake - expenditure, deficit negative), the EMA-smoothed weight trend against the goal line, steps/sleep/time-in-zone correlation overlays, and adaptive TDEE that self-corrects maintenance from observed weight change versus net energy.
