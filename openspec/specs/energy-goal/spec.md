...
# energy-goal Specification

## Purpose

Defines the body-composition goal engine: a deficit/surplus daily kcal delta derived from a start/target weight and target date with conservative safety caps and an explicit user override, a sport-aware periodized daily target, and protein/carb/fat macro targets.
