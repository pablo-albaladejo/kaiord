import type { Sport, WorkoutStep } from "@kaiord/core";
...
const convertTargetValueToTcx = (
  ...
  if (type === "cadence") return convertCadenceToTcx(value, sport);
  return NONE_TCX;
};
...
export const convertTargetToTcx = (
  ...
  return convertTargetValueToTcx(target.type, target.value, sport);
};
