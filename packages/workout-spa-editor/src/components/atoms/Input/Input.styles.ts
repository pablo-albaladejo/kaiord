...
export const errorStateClasses =
  "border-danger-border bg-danger-bg text-danger-text placeholder-ink-muted focus:border-danger-border focus:ring-danger dark:focus:ring-danger";
...
export const errorTextClasses = "mt-1 text-sm text-danger-text";
