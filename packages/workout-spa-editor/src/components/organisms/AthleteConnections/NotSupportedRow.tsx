...
export function NotSupportedRow({ config }: NotSupportedRowProps) {
  return (
    <div
      ...
      className="flex w-full items-center gap-3 rounded-2xl border border-edge bg-surface p-3 opacity-70"
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="text-[12.5px] text-ink-muted">Not supported yet</div>
      </div>
    </div>
  );
}
