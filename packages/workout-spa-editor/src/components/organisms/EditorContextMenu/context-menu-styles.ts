...
export const deleteItemClass =
  "flex items-center gap-2 px-3 py-2 text-sm text-red-600 dark:text-red-400 rounded cursor-pointer outline-none hover:bg-red-50 dark:hover:bg-red-900/20 data-[highlighted]:bg-red-50 dark:data-[highlighted]:bg-red-900/20 focus-visible:ring-2 focus-visible:ring-red-500";

export const shortcutClass = "ml-auto text-xs text-gray-400 dark:text-gray-500";
