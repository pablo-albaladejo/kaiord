...
| ~~`components/organisms/AthleteConnections/AvailableRow.tsx`~~ | **#27 CLOSED by deletion (connections cutover):** the row, the whole `AthleteConnections/` tree and `/settings/extensions` are gone. Every brand now has its own card on `/settings/connections`, so there is no generic hop left to relabel.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
