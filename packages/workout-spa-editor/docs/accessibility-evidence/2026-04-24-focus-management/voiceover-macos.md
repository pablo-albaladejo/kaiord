# VoiceOver (macOS) Transcript — Focus Management
...
_(Paste the timestamped speech events from Accessibility Inspector here.
Format: `[HH:MM:SS.mmm] <announced text>` followed by an annotation line
describing the expected announcement for the action.)_
