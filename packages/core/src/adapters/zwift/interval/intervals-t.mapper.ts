...
const createOnStep = (data: ZwiftIntervalsTData): WorkoutStep => {
  ...
  // Store cadence in extensions if power target is primary
...
const createOffStep = (data: ZwiftIntervalsTData): WorkoutStep => {
