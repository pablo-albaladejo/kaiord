...
export const durationSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    type: z.literal(durationTypeEnum.enum.repeat_until_heart_rate_greater_than),
    bpm: z.number().int().positive(),
    repeatFrom: z.number().int().nonnegative(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.calories),
    calories: z.number().int().positive(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.power_less_than),
    watts: z.number().positive(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.power_greater_than),
    watts: z.number().positive(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.repeat_until_time),
    seconds: z.number().positive(),
    repeatFrom: z.number().int().nonnegative(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.repeat_until_distance),
    meters: z.number().positive(),
    repeatFrom: z.number().int().nonnegative(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.repeat_until_calories),
    calories: z.number().int().positive(),
    repeatFrom: z.number().int().nonnegative(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.repeat_until_heart_rate_less_than),
    bpm: z.number().int().positive(),
    repeatFrom: z.number().int().nonnegative(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.repeat_until_power_less_than),
    watts: z.number().positive(),
    repeatFrom: z.number().int().nonnegative(),
  }),
  z.object({
    type: z.literal(durationTypeEnum.enum.repeat_until_power_greater_than),
    watts: z.number().positive(),
    repeatFrom: z.number().int().nonnegative(),
  }),
  z.object({
