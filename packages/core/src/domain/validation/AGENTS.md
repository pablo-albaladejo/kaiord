...
| File                   | Description                                                                                                                                                                                                                                      |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `index.ts`             | Barrel — exports `extractWorkout`, `SchemaValidator`+`createSchemaValidator`, `ToleranceChecker`+`ToleranceConfig`+`createToleranceChecker`+`DEFAULT_TOLERANCES`+`toleranceConfigSchema`+`toleranceViolationSchema`, and `validateKrd`.          |
