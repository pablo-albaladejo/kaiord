...
3. Read ${changeDir}/proposal.md and ${changeDir}/design.md. Identify external blockers — notably that Phases 2-5 are gated on a Google Cloud OAuth Client ID and the "drive.appdata" sensitive-scope verification. Phase 1 (snapshot export/import + tombstones) has NO external blocker.
