...
| `check-bridge-privacy-surface.mjs`                        | Locks every bridge's manifest surface, read allowlist, external actions and credential-handshake endpoints against a golden. | `pnpm test:scripts`                                                           |
